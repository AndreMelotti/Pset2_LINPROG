...
class TestInvertido(unittest.TestCase):
    ...
    def test_invertido_2(self):                                         # Teste de inversão, Questão 01 do pset2.
        imagem = pset2.Imagem(4, 1, [29, 89, 136, 200])
        resultado = imagem.invertido()                                  #Invocação do Método que inverte a imagem
        esperado = pset2.Imagem(4, 1, [226, 166, 119, 55])

        self.assertTrue(resultado, esperado)                            # Método de verificação, que confirma se é um igual o outro ou não
